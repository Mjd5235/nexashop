            ...
            <div style={{ display: "flex", }}>
                {sided ?
                    <div style={{ width: "250px", }}>
                        <Sidebar height="4000px" font="Products" />
                    </div>
                    : null}
                    ...
                    <div style={{ width: sided ? "1655px" : "1920px", marginLeft: sided ? "250px" : "0", marginLeft: sided ? "0px" : "", }}>
                        ...
                        <div style={{ display: "grid", marginLeft: "150px", }}>
                            ...
                            <div style={{ display: "flex", marginTop: "30px", justifyContent: "space-between" }}>
                                ...
                                <div style={{ fontWeight: "bold", background: "linear-gradient(to right, #1a75e8, #92d0ff)", fontWeight: "700", fontSize: "32px", letterSpacing: "0.5px", color: "transparent", whiteSpace: 'nowrap', backgroundClip: "text", width: "350px", marginLeft: "30px" }}>Products Inventory</div>
